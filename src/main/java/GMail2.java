 ...
 */
public class GMail2 {
    private static final String APPLICATION_NAME = "LTCQA";
    ...
    public static List<Message> listMessagesMatchingQuery(Gmail service, String userId,
      ...
      //  System.out.println(response.toString() + " end here");
    ...
    public static Message getMessage(Gmail service, String userId, List<Message> messages, int index)
       ...
       // System.out.println("The message found "+ message);   
    ...
    public static HashMap<String, String> getGmailData(String query) {
        try {
			...
			/*
			 * for (Message a : messages) { //prints the elements of the List
			 * System.out.println(a); }
			 */ 
            
            // if the subject is "Security Code" index is 1, and for rest 0 
            
            if (query.equalsIgnoreCase("subject:Security Code"))
            {message = getMessage(service, USER_ID, messages, 1);
            }
            else
            	message = getMessage(service, USER_ID, messages, 0);
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException {
        HashMap<String, String> hm = getGmailData("subject:John Hancock Insurance New Security Code");
        ...
        System.out.println("=================");
        boolean exist = isMailExist("Hello");
